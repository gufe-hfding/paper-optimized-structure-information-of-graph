# this file is got from https://github.com/acekillersg/partitionGenerator
...
if __name__ == "__main__":
    ...
    for idx, item in enumerate(partition(layer_list_3), 1):
        print(item)

    print("Number of all parintions:")
    partitions = enumerate(partition(layer_list_3), 1)
